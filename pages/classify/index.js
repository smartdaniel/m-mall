  ...
  getList() {
    ...
    this.classify.queryAsync(params)
      .then(data => {
        console.log(data)
        if (data.code == 0) {
          classify.items = [...classify.items, ...data.items]
          classify.paginate = data.paginate
          classify.params.page = data.paginate.next
          classify.params.limit = data.paginate.perPage
          this.setData({
            classify: classify,
